...
<body>
    <header>
        ...
        <ul class="navbar">
            ...
            <li><a href="#servicos">Reservas</a></li>
    ...
    <section class="servicos" id="servicos">
        ...
        <div class="servicos-container">
            <div class="box">
                <div class="box-img">
                    <img src="img/car1.jpg" alt="Toyota Hilux">
                </div>
                <p>2023</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/car2.jpg" alt="Chevrolet Ônix">
                </div>
                <p>2021</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/HR-V 2.jpg" alt="Honda HR-V">
                </div>
                <p>2023</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/Compass.jpeg"Jeep Compass">
                </div>
                <p>2024</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/car5.jpg" alt="Range Rover Sport">
                </div>
                <p>2021</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/car6.jpg" alt="Volkswagem Gol">
                </div>
                <p>2021</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/corolla-2023.jpg" alt="Toyota Corolla 2023">
                </div>
                <p>2023</p>
            ...
            <div class="box">
                <div class="box-img">
                    <img src="img/Taos.jpg" alt="Volkswagem Taos">
                </div>
                <p>2023</p>
    ...
    <section class="sobre" id="sobre">
        ...
        <div class="sobre-container">
            <div class="sobre-img">
                <img src="img/Corolla-Altis.png" alt="Toyota Corolla Altis">
            </div>
    ...
    <section class="reviews" id="reviews">
        ...
        <div class="reviews-container">
            <div class="box">
                <div class="rev-img">
                    <img src="img/1.jpeg" alt="Giovanna">
                </div>
                <h2>Giovanna</h2>
                <div class="stars">
